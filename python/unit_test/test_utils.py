...
class TestDeleteDockerImage(TestCase):
    ...
    def test_delete_docker_image_no_reg_image(self, mock_reg, mock_conf):
        ...
        self.assertEqual(utils._delete_docker_image(proj_name), None)

    @mock.patch("sys.stdout", new_callable=io.StringIO)
    @mock.patch("utils.docker.from_env")
    @mock.patch("utils._get_config_data")
    @mock.patch("utils._get_registry_data")
    def test_delete_docker_image_test_2(
        self, mock_reg, mock_conf, mock_env, mock_stdout
    ):
        """
        Test config:
        ...
        # No custom image.
        conf_data = {"base-image": "base_image"}
        # Delete project.
        del_proj = False
        mock_reg.return_value = reg_data
        mock_conf.return_value = conf_data
    ...
    @mock.patch("utils._get_config_data")
    @mock.patch("utils._get_registry_data")
    def test_delete_docker_image_test_3(
        self, mock_reg, mock_conf, mock_env, mock_stdout
    ):
        """
        Test config:
        ...
        reg_data = {proj_name: {"docker-image": reg_im}}
        # No custom image.
        conf_data = {"base-image": "base_image", "replace-image-on-rebuild": True}
        # Delete project.
        del_proj = False
        mock_reg.return_value = reg_data
        mock_conf.return_value = conf_data
    ...
    @mock.patch("utils._get_config_data")
    @mock.patch("utils._get_registry_data")
    def test_delete_docker_image_test_4(
        self, mock_reg, mock_conf, mock_env, mock_stdout
    ):
        """
        Test config:
    ...
    @mock.patch("utils._get_config_data")
    @mock.patch("utils._get_registry_data")
    def test_delete_docker_image_test_5(
        self, mock_reg, mock_conf, mock_env, mock_stdout
    ):
        """
        Test config:
    ...
    @mock.patch("utils._get_config_data")
    @mock.patch("utils._get_registry_data")
    def test_delete_docker_image_test_6(
        self, mock_reg, mock_conf, mock_env, mock_stdout
    ):
        """
        Test config:
    ...
    @mock.patch("utils._get_config_data")
    @mock.patch("utils._get_registry_data")
    def test_delete_docker_image_test_7(
        self, mock_reg, mock_conf, mock_env, mock_stdout
    ):
        """
        Test config:
...
class TestTempCopyLocalFiles(TestCase):
    ...
    @mock.patch("utils._get_config_data")
    def test_temp_copy_local_files_test_3(
        self, mock_conf, mock_folder, mock_exists, mock_isdir, mock_copytree, mock_mkdir
    ):
        """
        Test config:
            - 'add-files' in 'conf_data'
    ...
    @mock.patch("utils._get_project_folder", return_value="/my/proj")
    @mock.patch("utils._get_config_data")
    def test_temp_copy_local_files_test_4(
        self,
        mock_conf,
        mock_folder,
        mock_exists,
    ...
    @mock.patch("utils._get_project_folder", return_value="/my/proj")
    @mock.patch("utils._get_config_data")
    def test_temp_copy_local_files_test_5(
        self,
        mock_conf,
        mock_folder,
        mock_exists,
...
class TestRemoveTempFiles(TestCase):
    ...
    def test_remove_temp_files_exists(self, mock_rmtree, mock_exists, mock_folder):
        """
        Test config:
            - path exists
        """
    ...
    @mock.patch("utils.os.path.exists", return_value=True)
    @mock.patch("utils.shutil.rmtree")
    def test_remove_temp_files_does_not_exist(
        self, mock_rmtree, mock_exists, mock_folder
    ):
        """
        Test config:
            - path exists
...
class TestGetRegistryLists(TestCase):
    ...
    @mock.patch("utils._get_registry_data", return_value={"proj1": {}, "proj2": {}})
